    ...
    <div style="text-align: center;">
        ...
        <table style="width: 90%; margin: 20px auto">
            ...
            <tr>
                ...
                <td><h5><fmt:parseDate value="${board.modifiedAt}" pattern = "yyyy-MM-dd'T'HH:mm" type="both"/>
                                    <fmt:formatDate pattern = "dd.MM.yyyy HH:mm" value="${parseDateTime}"/></h5></td>
            </tr>
            <tr>
